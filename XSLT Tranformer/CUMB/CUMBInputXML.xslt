...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:cumbpir="http://njm.com/esb/pds/cumb/1.0/interfaces/CUMBPolicyInfomationRetriever"
                xmlns:js="http://www.url.com"
                xmlns:typ="http://njm.com/esb/pds/cumb/1.0/types"
                xmlns:esbcommon="http://njm.com/esb/common/types"
                xmlns:ebt="http://njm.com/esb/business/1.3.0/types"
  ...
  <xsl:template match="cumbpir:retrievePolicyByPolicyNumberResponse">
    <xsl:apply-templates/>
  </xsl:template>

  <xsl:template match="cumbpir:retrievePolicyByQuoteNumberResponse">
    <xsl:apply-templates/>
  </xsl:template>
