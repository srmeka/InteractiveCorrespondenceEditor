...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:typ="http://njm.com/esb/pds/cumb/1.0/types" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:js="http://www.url.com" exclude-result-prefixes="msxsl js">
      ...
      <CustomerData>
        <RecordDelim>
          <AccountRecord>
            ...
            <OnBaseKeyword1>U</OnBaseKeyword1>
            <DocumentRecipient></DocumentRecipient>
            <LineOfBusiness>Commercial Excess and Umbrella</LineOfBusiness>
            ...
            <Value12>Commercial Excess and Umbrella</Value12>
          </AccountRecord>
