...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:boppir="http://njm.com/esb/pds/bop/1.0/interfaces/BOPPolicyInfomationRetriever"
  ...
  <xsl:template match="boppir:retrievePolicyByPolicyNumberResponse">
    <xsl:apply-templates/>
  </xsl:template>

  <xsl:template match="boppir:retrievePolicyByQuoteNumberResponse">
    <xsl:apply-templates/>
  </xsl:template>
