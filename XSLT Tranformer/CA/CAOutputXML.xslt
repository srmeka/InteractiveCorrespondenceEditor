       ...
       <CustomerData>
        <RecordDelim>
          <AccountRecord>
            ...
            <OnBaseKeyword1>A</OnBaseKeyword1>
            <DocumentRecipient></DocumentRecipient>
            <LineOfBusiness>Commercial Automobile</LineOfBusiness>
            ...
            <Value12>Commercial Auto</Value12>
          </AccountRecord>
        ...
        <PolEffectiveDate><xsl:value-of select="CorrespondenceDataResponse/Policy/StartDt"/></PolEffectiveDate>
            <PolicyEffectiveYear>
              <xsl:value-of select="substring(CorrespondenceDataResponse/Policy/StartDt,0,5)"/>
           </PolicyEffectiveYear>
            <PolExpirationDate><xsl:value-of select="CorrespondenceDataResponse/Policy/EndDt"/></PolExpirationDate>
        </CAPolicyRecord>
