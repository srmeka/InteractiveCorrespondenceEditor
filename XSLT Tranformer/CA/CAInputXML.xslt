...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:msxsl="urn:schemas-microsoft-com:xslt"  xmlns:js="http://www.url.com" xmlns:capir="http://njm.com/esb/pds/ca/1.0/interfaces/CAPolicyInfomationRetriever" xmlns:typ="http://njm.com/esb/pds/ca/1.0/types" xmlns:esbcommon="http://njm.com/esb/common/types" xmlns:ebt="http://njm.com/esb/business/1.3.0/types" exclude-result-prefixes="msxsl js">
  ...
  <xsl:template match="capir:retrievePolicyByPolicyNumberResponse">
    <xsl:apply-templates/>
  </xsl:template>

  <xsl:template match="capir:retrievePolicyByQuoteNumberResponse">
    <xsl:apply-templates/>
  </xsl:template>
  ...
  <!-- Remove PolicyLines -->
  <!-- commeented to pass for Vehicle coverage letter This data is needed now-->
  <!--<xsl:template match="typ:PolicyLines"/>-->
  
  <!-- Remove Listed Drivers nodes  -->
  <xsl:template match="typ:ListedDrivers"/>
