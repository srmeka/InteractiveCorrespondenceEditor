...
>
  <!-- UMB OUTPUT XML xslt - parse ICE input xml into Interactive XML -->
      ...
      <CUSTOMER_DATA>
        <RECORD_DELIM>
          <UMBRELLA_REC>
            ...
            <ENDRS_EFF_DT>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/Endorsements/EndorsementEffectiveDt"/>
            </ENDRS_EFF_DT>
            <TOT_PREM>
              <xsl:value-of select="CorrespondenceDataResponse/PolicyPeriod/PolicyLines/UmbrellaLine/SummaryAmounts/SummaryAm"/>
            </TOT_PREM>
            <POL_MAIL_ADDR_1>
            ...
            <PRIM_INSD_EMAIL>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/ListedParties/Party[PartyRoles[text()='Primary Named Insured']]/Person/PersonName/EmailAddresses/EmailAddress/UnparsedEmailAddress"/>
            </PRIM_INSD_EMAIL>
            <FORM_TYPE>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/FormPattern/FormDescriptionNm"/>
            </FORM_TYPE>

            <LMT_LIAB>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/CoverageElectionParameters[CoverageParameterTypeCd[text()='Liability Limit']]/CoverageParameterUnformattedValueTx"/>
            </LMT_LIAB>
            <TOT_POL_PREM>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/SummaryAmounts[AmountTypeCd[text()='Total Policy Premium']]/SummaryAm"/>
            </TOT_POL_PREM>

            <SUB_POL_PREM>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/SummaryAmounts[AmountTypeCd[text()='Subtotal Policy Premium']]/SummaryAm"/>
            </SUB_POL_PREM>
            <PLIGA>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/SummaryAmounts[AmountTypeCd[text()='NJ PLIGA Charge']]/SummaryAm"/>
            </PLIGA>
            <PRIOR_POL_PD_YR>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/DividendYr"/>
            </PRIOR_POL_PD_YR>
            <ESCROW_IND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/UmbrellaLine/FinancialInstitution/EscrowIn"/>
            </ESCROW_IND>

            <TOT_ADD_RETURN_PREM>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/SummaryAmounts[AmountTypeCd[text()='Premium']]/SummaryAm"/>
            </TOT_ADD_RETURN_PREM>

            <!--<PLIGA>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/NonCoverageCharge/ChargeAm"/>
            </PLIGA>-->
            <DIVIDEND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/CoverageElectionParameters[CoverageParameterTypeCd[text()='dividend']]/CoverageParameterUnformattedValueTx"/>
            </DIVIDEND>
            <POL_MAILING_ADD_IND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyMailingAddressIn"/>
            </POL_MAILING_ADD_IND>
            <ADJ_TOT_DIV>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PUPRegularDividendAmount"/>
            </ADJ_TOT_DIV>

            <MOTORCYCLE_IND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/ExposureIndicators/MotorCycleIndicators/MotorCycleIn"/>
            </MOTORCYCLE_IND>
            <AUTOMOBILE_IND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/ExposureIndicators/AutoMobileIndicators/AutoMobileIn"/>
            </AUTOMOBILE_IND>
            <RES_PREM_IND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/ExposureIndicators/ResidencePremisesIndicator "/>
            </RES_PREM_IND>
            <VACANT_LAND_IND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/ExposureIndicators/VacatLandIndicators/VacantLandIn"/>
            </VACANT_LAND_IND>
            <WATERCRAFT_IND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/ExposureIndicators/WatercraftIndicators/WatercraftIn"/>
            </WATERCRAFT_IND>
            <FAM_MEM_IND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/ExposureIndicators/FamilyMemberIn"/>
            </FAM_MEM_IND>
            <RV_IND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/ExposureIndicators/RecreationalMotorVehicleIndicators/RecreationalVehicleIn"/>
            </RV_IND>
            <UM_UIM_IND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/ExposureIndicators/ExcessUnUnderInsuredIn"/>
            </UM_UIM_IND>
            <RENTAL_PROP_IND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/ExposureIndicators/RentalPropertyIn"/>
            </RENTAL_PROP_IND>
            <BOAT_SLIP_IND>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/UmbrellaLine/ExposureIndicators/BoatSlipIn"/>
            </BOAT_SLIP_IND>
            <OB_KEYWORD1>
              <xsl:if test="CorrespondenceDataResponse/Policy/PolicyNumber != 'Unassigned'">
           ...
           <OB_KEYWORD2>
            ...
            <OB_KEYWORD3>UMBRELLA</OB_KEYWORD3>
            ...
            <EMAIL_BODY>umbrella</EMAIL_BODY>
            <EMAIL_SUBJECT>Requested NJM Umbrella Information</EMAIL_SUBJECT>
            <POL_NO_PAD>
              <xsl:if test="CorrespondenceDataResponse/Policy/PolicyNumber != 'Unassigned'">
