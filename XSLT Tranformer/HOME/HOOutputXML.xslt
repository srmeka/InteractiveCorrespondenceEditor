...
>
  <!-- HO OUTPUT XML xslt - parse ICE input xml into Interactive XML -->
      ...
      <CUSTOMER_DATA>
        <RECORD_DELIM>
          <HOMEOWNERS_REC>
            ...
            <COV_D_LMT_LIAB>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/HomeownersLine/CoveragesElectionParameters[CoverageTypeCd[text()='Coverage D - Loss of Use']]/CoverageParameterUnformattedValueTx"/>
            </COV_D_LMT_LIAB>

            <COV_E_LMT_LIAB>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/HomeownersLine/CoveragesElectionParameters[CoverageTypeCd[text()='Coverage E - Personal Liability']]/CoverageParameterUnformattedValueTx"/>
            </COV_E_LMT_LIAB>
            ...
            <SUB_POL_PREM>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/PolicyLines/HomeownersLine/SummaryAmounts[AmountTypeCd[text()='Subtotal Policy Premium']]/SummaryAm"/>
            </SUB_POL_PREM>
            <PLIGA>
            ...
            <REG_DIV>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/TotalDividendAm"/>
            </REG_DIV>
            ...
            <PRIMARY_POL_NUM>
              <xsl:value-of select="CorrespondenceDataResponse/Policy/PolicyPeriod/RelatedPolicies[RelationshipReasonCd[text()='Primary']]/Policy/PolicyNumber"/>
            </PRIMARY_POL_NUM>           
            ...
            <EMAIL_BODY>homeowner</EMAIL_BODY>
            <EMAIL_SUBJECT>Requested NJM Homeowners Information</EMAIL_SUBJECT>
            <POL_NO_PAD>
              <xsl:if test="CorrespondenceDataResponse/Policy/PolicyNumber != 'Unassigned'">
