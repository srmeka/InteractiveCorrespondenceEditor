...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"
    xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:re="http://njm.com/esb/pds/pa/1.0/interfaces/PolicyInfomationRetriever" xmlns:js="http://www.url.com" exclude-result-prefixes="msxsl js">
  ...
  <xsl:template match="re:retrievePolicyByPolicyNumberResponse">
    <xsl:apply-templates/>
  </xsl:template>

  <xsl:template match="re:retrievePolicyByQuoteNumberResponse">
    <xsl:apply-templates/>
  </xsl:template>
