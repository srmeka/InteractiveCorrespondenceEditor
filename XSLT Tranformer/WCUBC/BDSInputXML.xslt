...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:esb="http://njm.com/esb/wcu/bc/1.0/WCUBillingDataService" xmlns:tns="http://schemas.xmlsoap.org/soap/envelope/" xmlns:types="http://njm.com/esb/wcu/bc/bds/1.0/types" xmlns:msxsl="urn:schemas-microsoft-com:xslt"  xmlns:js="http://www.url.com" xmlns:typesProdStmt="http://njm.com/esb/wcu/bc/bds/producerstatments/1.0/types" xmlns:typespp="http://njm.com/esb/wcu/bc/bds/policyperoid/1.0/types" xmlns:typ1="http://njm.com/esb/wcu/bc/bds/policyperoid/1.0/types" exclude-result-prefixes="msxsl js">
  ...
  <!-- Remove retrievePolicyInvoiceDetailsOut xml node -->
  ...
  <!-- Remove retrieveInvoiceTransactionsResponse xml node  SP1483-->
  ...
  <!-- Remove typespp: from each node and use actual node name for element -->
  <xsl:template match="typespp:*">
