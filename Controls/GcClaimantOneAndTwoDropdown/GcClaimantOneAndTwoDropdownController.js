app.controller('GcClaimantOneAndTwoDropdownController', function ($scope, $http, shareData, HomeService) {
    try {
    ...
    $scope.$on('GcClaimantOneAndTwoDropdown', function (event) {
        try {
            var outputName = '', outputName2 = '';
            ...
            HomeService.createPrimaryXML("CLMT_NAME_1", outputName.trim());
