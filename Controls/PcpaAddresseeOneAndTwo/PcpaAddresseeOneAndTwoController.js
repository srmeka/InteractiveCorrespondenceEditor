app.controller('PcpaAddresseeOneAndTwoController', function ($scope, shareData, $http, HomeService) {
    try {
        ...
        if (varAddresseeName2NameSalutationCd) {
        ...
        if (varAddresseeName2MiddleName) {
        ...
        if (varAddresseeName2DisplayNameSuffix) {
    ...
    $scope.$on('PcpaAddresseeOneAndTwo', function (event) {
        try {
