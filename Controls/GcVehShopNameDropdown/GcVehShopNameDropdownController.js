app.controller('GcVehShopNameDropdownController', function ($scope, $http, shareData, HomeService) {
    try {
    ...
    $scope.$on('GcVehShopNameDropdown', function (event) {
        try {
            var outputName = '';
            ...
            HomeService.createPrimaryXML("VEH_SHOP_NAME", outputName.trim());
