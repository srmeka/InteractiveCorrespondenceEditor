app.controller('GcClaimantNameFourDropdownController', function ($scope, $http, shareData, HomeService) {
    try {
    ...
    $scope.$on('GcClaimantNameFourDropdown', function (event) {
        try {
            
            var outputName = '', outputName2 = '', outputName3 = '', outputName4 = '';
            var codeNum = 0;
