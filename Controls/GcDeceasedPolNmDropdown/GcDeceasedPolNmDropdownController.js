app.controller('GcDeceasedPolNmDropdownController', function ($scope, $http, shareData, HomeService) {
    try {
    ...
    $scope.$on('GcDeceasedPolNmDropdown', function (event) {
        try {
            var outputName = '';
            ...
            HomeService.createPrimaryXML("DECEASED_POL_HLD_NAME", outputName.trim());
