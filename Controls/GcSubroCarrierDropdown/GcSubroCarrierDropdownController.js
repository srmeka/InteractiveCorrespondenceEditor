app.controller('GcSubroCarrierDropdownController', function ($scope, $http, shareData, HomeService) {
    try {
    ...
    $scope.$on('GcSubroCarrierDropdown', function (event) {
        try {
            var outputName = '';
            ...
            HomeService.createPrimaryXML("SUBRO_CARRIER_NAME", outputName.trim());
