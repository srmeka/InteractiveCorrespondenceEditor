app.controller('PchoHo61AddAdtlInfoRepeaterwCheckboxController', function ($scope, $http, $filter, shareData, HomeService) {
    try {
        ...
        $scope.colorOrClarityData = ['color', 'clarity', 'color and clarity'];
            ...
            $scope.clearAllData = function (clearId) {
                ...
                //$scope.SelectedH061[clearId] = undefined;
            }
    ...
    $scope.$on('PchoHo61AddAdtlInfoRepeaterwCheckbox', function (event) {
        try {
            var isCreateTable;
            if ($scope.SelectedH061.length > 0) {
                ...
                for (var i = 0; i < $scope.TotalCount.length; i++) {
                    ...
                    if ($scope.SelectedH061[i]) {
                        ...
                        HomeService.createSecondaryXMLValue("HO61_ADTL_INFO", "HO_61_ADDL_TYPE", "Added", id);
            ...
            if (isCreateTable) {
                HomeService.createPrimaryXML("HO_61_ADD_ADDL_INFO", "Y");
            } else {
                HomeService.createPrimaryXML("HO_61_ADD_ADDL_INFO", "N");
            }
