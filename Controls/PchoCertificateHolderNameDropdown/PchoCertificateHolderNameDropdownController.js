app.controller('PchoCertificateHolderNameDropdownController', function ($scope, shareData, $http, HomeService) {
    try {
    ...
    $scope.$on('PchoCertificateHolderNameDropdown', function (event) {
