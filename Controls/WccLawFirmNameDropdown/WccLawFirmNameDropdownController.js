app.controller('WccLawFirmNameDropdownController', function ($scope, $http, shareData, HomeService) {
    try {
    ...
    $scope.$on('WccLawFirmNameDropdown', function (event) {
        try {
            ...
            HomeService.createPrimaryXML("OUTSD_LAW_FIRM_NAME", outputName.trim());
