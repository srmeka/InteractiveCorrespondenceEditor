app.controller('PchodwumbAddrNmOneTwoThreewGreetNmController', function ($scope, shareData, $http, HomeService) {
    try {
        ...
        var varAddrNm1NoNmSalutation = "";
        var varAddrNm2NoNmSalutation = "";
        var varAddrNm3NoNmSalutation = "";
        ...
        if (varAddresseeName2FirstName.length > 0) {
            ...
            varAddrNm2NoNmSalutation = varAddresseeName2FirstName;
        }
        ...
        if (varAddresseeName2MiddleName.length > 0) {
            ...
            varAddrNm2NoNmSalutation = varAddrNm2NoNmSalutation + " " + varAddresseeName2MiddleName;
        }
        ...
        if (varAddresseeName2LastName.length > 0) {
            ...
            varAddrNm2NoNmSalutation = varAddrNm2NoNmSalutation + " " + varAddresseeName2LastName;
        }
        ...
        if (varAddresseeName2DisplayNameSuffix.length > 0) {
            ...
            varAddrNm2NoNmSalutation = varAddrNm2NoNmSalutation + " " + varAddresseeName2DisplayNameSuffix;
        }
        ...
        if (varAddresseeName3FirstName.length > 0) {
            ...
            varAddrNm3NoNmSalutation = varAddresseeName3FirstName;
        }
        ...
        if (varAddresseeName3MiddleName.length > 0) {
            ...
            varAddrNm3NoNmSalutation = varAddrNm3NoNmSalutation + " " + varAddresseeName3MiddleName;
        }
        ...
        if (varAddresseeName3LastName.length > 0) {
            ...
            varAddrNm3NoNmSalutation = varAddrNm3NoNmSalutation + " " + varAddresseeName3LastName;
        }
        ...
        if (varAddresseeName3DisplayNameSuffix.length > 0) {
            ...
            varAddrNm3NoNmSalutation = varAddrNm3NoNmSalutation + " " + varAddresseeName3DisplayNameSuffix;
        }
        ...
        $scope.updateGreetingName = function () {
            var GreetingName = "";
            if (varAddrNm1NoNmSalutation && $scope.AddresseeName2Chk && $scope.AddresseeName3Chk) {
                GreetingName = "Dear " + varAddrNm1NoNmSalutation + ", " + varAddrNm2NoNmSalutation + " and " + varAddrNm3NoNmSalutation;
            }
            else if (varAddrNm1NoNmSalutation && $scope.AddresseeName2Chk) {
                GreetingName = "Dear " + varAddrNm1NoNmSalutation + " and " + varAddrNm2NoNmSalutation;
            }
            else if (varAddrNm1NoNmSalutation && $scope.AddresseeName3Chk) {
                GreetingName = "Dear " + varAddrNm1NoNmSalutation + " and " + varAddrNm3NoNmSalutation;
            }
            else if ($scope.AddresseeName2Chk && $scope.AddresseeName3Chk) {
                GreetingName = "Dear " + varAddrNm2NoNmSalutation + " and " + varAddrNm3NoNmSalutation;
            }
            else if (varAddrNm1NoNmSalutation) {
                GreetingName = "Dear " + varAddrNm1NoNmSalutation;
            }
            else if ($scope.AddresseeName2Chk) {
                GreetingName = "Dear " + varAddrNm2NoNmSalutation;
            }
            else if ($scope.AddresseeName3Chk) {
                GreetingName = "Dear " + varAddrNm3NoNmSalutation;
            }

            $scope.GreetingName = GreetingName;
        }
    }
    catch (ex) {
    ...
    $scope.$on('PchodwumbAddrNmOneTwoThreewGreetNm', function (event) {
        try {
