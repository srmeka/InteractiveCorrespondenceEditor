app.controller('PcpaVehicleCheckboxLstNotReqController', function ($scope, shareData, $http, HomeService) {
    try {
        ...
        $scope.selectVehicle = function (Vehicle) {
            var vehicleId = "VehicleLstId" + Vehicle.VehicleId;
            ...
            if (document.getElementById(vehicleId).checked) {
                ...
                $scope.SelectedVehicle.pop(Vehicle);
            }
        }
    ...
    $scope.$on('PcpaVehicleCheckboxLstNotReq', function (event) {
        try {
