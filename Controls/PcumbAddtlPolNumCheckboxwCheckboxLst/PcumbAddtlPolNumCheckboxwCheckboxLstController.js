app.controller('PcumbAddtlPolNumCheckboxwCheckboxLstController', function ($scope, shareData, $http, HomeService) {
    try {
    ...
    $scope.$on('PcumbAddtlPolNumCheckboxwCheckboxLst', function (event) {
        try {
