app.controller('GcAttnyNmAndAddrDropdownController', function ($rootScope, $scope, shareData, $http, HomeService) {
    try {
    ...
    $scope.$on('GcAttnyNmAndAddrDropdown', function (event) {
        try {
               ...
               if($scope.nameSelector){
                ...
                HomeService.createPrimaryXML("ATTNY_NAME_AUTO", addr_name.trim());
                HomeService.createPrimaryXML("ATTNY_ST_ADDR1_AUTO", addr_addr1);
                HomeService.createPrimaryXML("ATTNY_ST_ADDR2_AUTO", addr_addr2);
                HomeService.createPrimaryXML("ATTNY_CTY_AUTO", city);
                HomeService.createPrimaryXML("ATTNY_ST_AUTO", st);
                HomeService.createPrimaryXML("ATTNY_ZIP_AUTO", zip);
