app.controller('PchoHo61NoAddAdtlInfoRepeatwCheckboxController', function ($scope, $http, $filter, shareData, HomeService) {
    try {
    ...
    $scope.$on('PchoHo61NoAddAdtlInfoRepeatwCheckbox', function (event) {
        try {
            var isCreateTable;
            if ($scope.SelectedH061.length > 0) {
                ...
                for (var i = 0; i < $scope.TotalCount.length; i++) {
                    ...
                    if ($scope.SelectedH061[i]) {
                        ...
                        HomeService.createSecondaryXMLValue("HO61_ADTL_INFO", "HO_61_ADDL_TYPE", "Not Added", id);
            ...
            if (isCreateTable) {
                HomeService.createPrimaryXML("HO_61_NADD_ADDL_INFO", "Y");
            } else {
                HomeService.createPrimaryXML("HO_61_NADD_ADDL_INFO", "N");
            }
